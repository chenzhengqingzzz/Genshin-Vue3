<template>
  <div class="background">
    ...
    <img :src="require('../../assets/hero/ly'+lyheroxxs[dqzx].num+'D'+lyheroxxs[dqzx].sx+'.png')" alt="" class="bighero">
    <img src="../../assets/jiaosepage/sanhua.png" alt="" class="sanhua">
    <div class="yxname">{{lyheroxxs[dqzx].name}}</div>
    <img :src="require('../../assets/hero/ly'+lyheroxxs[dqzx].num+'Z'+lyheroxxs[dqzx].sx+'.png')" alt="" class="Lines">
    <div class="yxyy">
      <img src="../../assets/jtleft.png" alt="" class="jtleft" @click="dianji(dqzx-1)">
      <ul class="jskp">
        <li v-for="(p) in lyheroxxs.slice(arrow, arrow+6)" :key="p.num" @click="dianji(p.num)" :class="{xzjl1 : (p.num === dqzx)}">
